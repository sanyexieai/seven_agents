...
agents = [
    AgentModel(key='coordinator_main', name='主协调者', type='coordinator', description='全局任务协调', config={}, enabled=True),
    AgentModel(key='research_ai', name='AI趋势研究', type='research', description='专注AI领域', config={"domain": "AI"}, enabled=True),
    AgentModel(key='analysis_finance', name='金融分析', type='analysis', description='金融数据分析', config={"domain": "finance"}, enabled=True),
